...
<div class="container">
    <h2 class="text-center mb-4">
        <span class="badge bg-primary p-3 rounded-pill shadow">
            <i class="fas fa-user-circle me-2"></i>{{ __('messages.member_details') }}
        </span>
    </h2>
    ...
    <div class="card border-0 shadow-lg">
        <div class="card-header bg-gradient-primary text-white">
            <h4 class="mb-0">
                <i class="fas fa-id-card me-2"></i>{{ __('messages.profile_of') }} {{ $member->name }}
            </h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info-item mb-4 p-3 bg-light rounded">
                        <h5 class="text-secondary"><i class="fas fa-signature me-2"></i>{{ __('messages.full_name') }}</h5>
                ...
                <div class="col-md-6">
                    <div class="info-item mb-4 p-3 bg-light rounded">
                        <h5 class="text-secondary"><i class="fas fa-envelope me-2"></i>{{ __('messages.email') }}</h5>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info-item mb-4 p-3 rounded 
                        ...
                        <h5 class="text-secondary"><i class="fas fa-user-shield me-2"></i>{{ __('messages.status') }}</h5>
                        <p class="h4 
                ...
                <div class="col-md-6">
                    <div class="info-item mb-4 p-3 bg-light rounded">
                        <h5 class="text-secondary"><i class="far fa-calendar-alt me-2"></i>{{ __('messages.registration_date') }}</h5>
                        ...
                        <small class="text-muted">
                            @if($member->created_at->diffInDays(now()) < 30)
                                <span class="badge bg-warning text-dark animate-pulse">
                                    <i class="fas fa-bolt me-1"></i>{{ __('messages.new_member') }}
                                </span>
                            @else
                                {{ __('messages.member_since') }} {{ $member->created_at->diffForHumans() }}
                            @endif
                        </small>
                    </div>
                </div>
        ...
        <div class="card-footer bg-light d-flex justify-content-between align-items-center">
            ...
            <div class="actions">
                <a href="{{ route('members.edit', $member->id) }}" class="btn btn-primary">
                    <i class="fas fa-edit me-1"></i> {{ __('messages.edit_member') }}
                </a>
            </div>
        </div>
    </div>
